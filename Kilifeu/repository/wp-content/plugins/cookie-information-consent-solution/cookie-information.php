...
class CookieInformationPlugin {
    ...
    public function addConsentPopupScript () {
        ...
        echo '<script id="CookieConsent" src="https://policy.app.cookieinformation.com/uc.js" '. 
            ...
            .' '
            .(get_option( 'enable-gcm', false ) == 1 ? 'data-gcm-enabled="true"' : 'data-gcm-enabled="false"')
            .'></script>'
            .(get_option( 'enable-gcm', false ) == 1 ? $gcmCodeSnippet : '');
                ...
                <div class="settings-wrapper">
                    <form method="post" action="options.php">
                        <table class="form-table coi-table">
                            ...
                            <tr>
                                <th scope="row"><label for="enable-tcf">Enable Google Consent Mode</label></th>
                                <td>
                                    <div class="coi-checkboxes">
